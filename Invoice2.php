...
class Invoice
{
	...
	private $invoiceOrderTable = 'invoice_purchase';
	...
	{
		$sqlInsert = "INSERT INTO " . $this->invoiceOrderTable . "(user_id, order_reciever_name, order_reciever_address, order_total_before_tax, order_total_tax, order_tax_per, order_total_after_tax) VALUES ('" . $POST['userId'] . "', '" . $POST['companyName'] . "', '" . $POST['address'] . "', '" . $POST['subTotal'] . "', '" . $POST['taxAmount'] . "', '" . $POST['taxRate'] . "', '" . $POST['totalAftertax'] . "')";
