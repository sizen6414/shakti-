				...
				<div class="container dashboard__container">
					...
					<main>
						...
						<tr>
							...
							<td><a href="update-company.php? updateid=' . $name . '"  title="Update Invoice"><button class="btns"><i class="fa fa-edit"></i></button></a></td>
								
								
									<td><a href="delete-company.php?deleteid=' . $email . '"  title="Delete company"><button class="btns"><i class="fa fa-trash"></i></button></a></td>
										...
										<a href="adminaddcompany.php"><button style="margin-left: 30rem;" class="btns" name="Add Company"><i class=""></i>Add</button></a>
