					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							...
							<div class="form-group">
								<input value="<?php echo $invoiceValues['order_reciever_name']; ?>" type="text" class="form-control" name="companyName" id="companyName" placeholder="Company Name" autocomplete="off">
							</div>
							<div class="form-group">
								<textarea class="form-control" rows="3" name="address" id="address" placeholder="Your Address"><?php echo
								$invoiceValues['order_reciever_address']; ?></textarea>
							</div>
